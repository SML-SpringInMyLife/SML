...
<body>
	...
	<main>
		   <div class="enroll-container">
            <form action="/safty/enroll.do" method="post" id="enrollForm">
                ...
                <div class="title">
                    ...
                    <input name="saftyTitle" type="text" size="30" class="titletext">
                </div>
                <div class="content">
                    <span id="alram_body" style="display: none;">내용을 입력해 주세요</span>
                    <textarea name="saftyBody" class="bodytext"></textarea>
	...
	<script>
	 $(document).ready(function() {
	        ...
	        $("#cancelbtn").click(function() {
	            location.href = "/safty/list";
	        });

	        function addNewCategory(newCategoryName) {
	            $.ajax({
	                url: '/safty/category/add',
	                type: 'POST',
	        ...
	        function submitForm() {
	            ...
	            var saftyTitle = $('input[name=saftyTitle]').val().trim();
	            var saftyBody = $('textarea[name=saftyBody]').val().trim();
